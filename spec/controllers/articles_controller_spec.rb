...
RSpec.describe ArticlesController, type: :controller do
  ...
  describe "GET #edit" do
    ...
    before do
      @john = User.create(first_name: "John", last_name: "Blake", email: "john@example.com", password: "password")
    end
    ...
    context "non-owner is not allowed to edit other users' articles" do
      it "redirects to the root path" do
        fred = User.create(first_name: "Fred", last_name: "Conroy", email: "fred@example.com", password: "password")
        login_user fred
